...
## Corpus Check
- 90 files · ~5,196,603 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 561 nodes · 851 edges · 79 communities detected
...
- `buildPartialGenerationMessage()` --calls--> `getReadableErrorMessage()`  [INFERRED]
  src\app\canvas\page.tsx → src\lib\request.ts
- `handleSubmit()` --calls--> `getReadableErrorMessage()`  [INFERRED]
  src\app\canvas\page.tsx → src\lib\request.ts
...
Cohesion: 0.07
Nodes (29): generateImages(), providerFallbackError, UpstreamAPIError, main(), walk(), buildPartialGenerationMessage(), buildPromptForReferenceImages(), copyError() (+21 more)
...
Cohesion: 0.17
Nodes (17): assertFetchableImageUrl(), createWindow(), normalizeYouMindPromptsPayload(), readLimitedResponseBytes(), readPositiveIntegerField(), readStringField(), registerGalleryImageProtocol(), resolveAppIconPath() (+9 more)

### Community 7 - "Community 7"
Cohesion: 0.19
Nodes (18): extractGalleryImageRelativePath(), getGalleryImageContentType(), isInsideDirectory(), resolveGalleryImageFilePath(), chooseModel(), closePackaged(), ensureDir(), exists() (+10 more)
...
Cohesion: 0.19
Nodes (8): fetchExampleImageBlob(), getCompactImageFrameStyle(), getEditorialCardClass(), getEditorialCardEstimatedHeight(), getImageFrameStyle(), inferImageMimeType(), shouldUseElectronImageFetch(), toAttachedPromptFile()
...
Cohesion: 0.23
Nodes (13): deriveModelState(), handleProviderChange(), providerSummary(), getProviderDefaults(), getQualityOptionsByApiMode(), mergeModelPools(), normalizeDefaultModel(), normalizeModelValue() (+5 more)
...
Cohesion: 0.27
Nodes (6): downloadImage(), estimateBytes(), fileFromImage(), imageSrc(), normalizeBase64Image(), makePromptFiles()
...
- **Thin community `Community 33`** (2 nodes): `workbench-layout.tsx`, `WorkbenchLayout()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (2 nodes): `ExamplesPage()`, `page.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (2 nodes): `SettingsPage()`, `page.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (2 nodes): `MainNavigation()`, `main-navigation.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 65`** (1 nodes): `electron-packaging-config.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (1 nodes): `example-gallery.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (1 nodes): `examples-page.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (1 nodes): `gallery-data.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (1 nodes): `gallery-image-runtime.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (1 nodes): `image-card-detail.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (1 nodes): `model-config-normalization.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (1 nodes): `prompt-bar-import.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (1 nodes): `request-auth.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (1 nodes): `request-helpers.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (1 nodes): `request-origin-resolution.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (1 nodes): `settings-drawer-regressions.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (1 nodes): `settings-quality-normalization.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 78`** (1 nodes): `settings-save-chain.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `relative()` connect `Community 7` to `Community 1`, `Community 11`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 1` to `Community 7`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `handleSubmit()` connect `Community 1` to `Community 13`?**
